...
/**
   * The user states.
   */
@property (nonatomic, copy, nonnull)  NSArray<AgoraRtmStateItem *> * states;
@end
...
__attribute__((visibility("default"))) @interface AgoraRtmStateItem: NSObject
/**
...
__attribute__((visibility("default"))) @interface AgoraRtmLogConfig: NSObject
/**
 * Set log path. 
*/
...
__attribute__((visibility("default"))) @interface AgoraRtmProxyConfig: NSObject
/**
    The Proxy type.
    */
...
__attribute__((visibility("default"))) @interface AgoraRtmEncryptionConfig: NSObject
...
@property (nonatomic, copy, nullable) NSString *token;
   ...
   */
  @property (nonatomic, assign) BOOL withMetadata;
  /**
   * Whether to join channel with user presence
   */
  @property (nonatomic, assign) BOOL withPresence;
  /**
   * Whether to join channel with lock
   */
  @property (nonatomic, assign) BOOL withLock;
...
/**
   ...
   * that region.
   */
@property (nonatomic, assign) unsigned int areaCode;
...
@property (nonatomic, assign) BOOL useStringUserId;
   ...
   */
@property (nonatomic, assign, nullable) AgoraRtmLogConfig * logConfig;

  /**
   * The config for proxy setting
   */
@property (nonatomic, assign, nullable) AgoraRtmProxyConfig * proxyConfig;

  /**
   * The config for encryption setting
   */
@property (nonatomic, assign, nullable) AgoraRtmEncryptionConfig * encryptionConfig;
@end

__attribute__((visibility("default"))) @interface AgoraRtmErrorInfo: NSObject
...
- (NSObject*  _Nullable) getData;
- (AgoraRtmMessageType) getType;
@end
...
typedef void (^AgoraRtmTopicSubscriptionBlock)(AgoraRtmTopicSubscriptionResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmOperationBlock)(AgoraRtmCommonResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmGetMetadataBlock)(AgoraRtmGetMetadataResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmGetLocksBlock)(AgoraRtmGetLocksResponse * _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmWhoNowBlock)(AgoraRtmWhoNowResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmWhereNowBlock)(AgoraRtmWhereNowResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

typedef void (^AgoraRtmPresenceGetStateBlock)(AgoraRtmPresenceGetStateResponse* _Nullable response, AgoraRtmErrorInfo* _Nonnull errorInfo);

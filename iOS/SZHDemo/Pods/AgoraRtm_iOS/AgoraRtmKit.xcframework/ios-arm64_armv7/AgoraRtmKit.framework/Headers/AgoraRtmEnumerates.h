 ...
 * IP areas.
 */
typedef NS_ENUM(NSUInteger, AgoraRtmAreaCode) {
  /**
   * Mainland China.
   */
...
typedef NS_ENUM(NSInteger, AgoraRtmMessageType) {
  /**
    ...
    */
  AgoraRtmMessageTypeBinary = 0,
  /**
    1: The ascii message.
    */
  AgoraRtmMessageTypeString = 1,
};
...
typedef NS_ENUM(NSInteger, AgoraRtmClientConnectionChangeReason) {
   ...
   */
  AgoraRtmClientConnectionChangedStreamChannelNotAvailable = 22,
  /**

...
class LoginViewController: ABaseViewController {
...
//        vm.checkUpdate()
    ...
    @IBAction func onClickJoin(_ sender: UIButton) {
        ...
        if let tipString = LoginViewModel.checkInputValid(userName: userName, roomPsd: roomPsd, roomName: roomName) {
//            show(tipString)
            print("tipString:\(tipString)")
            return
        }
...
//        let info = LoginViewModel.Info(userName: userName,
//                                roomName: roomName,
//                                password: roomPsd,
...
//    func loginVMDidSuccessEntryRoomWithInfo(info: LoginViewModel.Info,
//                                            nvc: AgoraMeetingUI) {
//        dismissLoading()
//        present(nvc,
//                animated: true,
